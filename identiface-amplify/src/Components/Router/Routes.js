...
import TestPhoto from "../Tests/TestPhoto";
					...
					<Route path="/">
						<div className="addbackground">
							...
							<p className="paragraph">
								...
								The result would be a JSON object (which would be returned as HTTP request depending on the use case){" "}
								<br />
								that contains the result of the comparison, it will either show that a person is not matching anyone in
								the collection <br />
								or if a person matches someone from the collection it will return his name and how close they look
								alike.
							</p>

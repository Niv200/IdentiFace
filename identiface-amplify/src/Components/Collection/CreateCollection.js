...
export default function CreateCollection() {
  ...
  return (
    <div className="addbackground">
      <h1 className="listcollectionsh1">Create a new collection:</h1>
      <p className="paragraph">Ensure that collection name is longer than 5 characters, shorter than 25, and contains English letters only</p>
